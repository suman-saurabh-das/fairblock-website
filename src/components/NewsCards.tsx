...
const NewsCard = ({
  ...
  return (
    <div className="border border-black/50 dark:border-white/50 bg-white dark:bg-transparent duration-300 p-4 rounded-2xl hover:scale-[1.03] will-change-transform shadow-md shadow-black/20 dark:shadow-black">
