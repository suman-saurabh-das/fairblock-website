...
const newsCardsArray = [
  {
    imageUrl: "https://miro.medium.com/v2/resize:fit:828/format:webp/1*nqeeFwC-zmdEylSXtIMGQg.png",
    newsHeader:
      "Trustless and Unstoppable Al with Fairblock and Ritual",
    newsBody:
    ...
    newsLink: "https://medium.com/@0xfairblock/confidential-rituals-trustless-and-unstoppable-ai-with-dynamic-confidentiality-95ecaee66e4c",
    site: "medium.com",
    type: "news",
  },
  {
    imageUrl: "https://miro.medium.com/v2/resize:fit:828/format:webp/0*Fadf2P2PH7_UvkNa",
    newsHeader:
  ...
  {
    imageUrl: "https://miro.medium.com/v2/resize:fit:828/format:webp/0*7TfdDRazLdM0eumI",
    newsHeader: "Native Encryption for the OP Superchain with Camp and Fairblock",
    newsBody:
  ...
  {
    imageUrl: "https://miro.medium.com/v2/resize:fit:828/format:webp/0*3Yg5EJeVq7nI3GYu",
  ...
  {
    imageUrl: "https://miro.medium.com/v2/resize:fit:828/format:webp/1*iaGYDRZZiiYQ_TM4Mo_zpw.png",
  ...
  },
  {
    ...
    newsHeader: "What is fully homomorphic encryption and how will it change blockchain?",
    newsBody:
  ...
  {
    imageUrl: "https://www.fairblock.network/_next/image?url=https%3A%2F%2Fhackmd.io%2F_uploads%2FBJo97G8pC.png&w=1920&q=75",
    ...
    newsLink:
      "https://hackmd.io/@Fairblock/rkSiU78TR",
    site: "hackmd.io",
    type: "news",
  },
  {
    imageUrl: "https://miro.medium.com/v2/resize:fit:828/format:webp/1*zeb3NhzUNr9qeioTVRLmwQ.png",
